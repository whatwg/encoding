This repository hosts the [Encoding Standard](https://encoding.spec.whatwg.org/).
...
[maintainer guidelines](https://github.com/whatwg/meta/blob/master/MAINTAINERS.md) for guidelines.
